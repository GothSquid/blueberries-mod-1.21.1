...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.registerArmor((ArmorItem) ModItems.STAR_GARNET_HELMET);
        itemModelGenerator.registerArmor((ArmorItem) ModItems.STAR_GARNET_CHESTPLATE);
        itemModelGenerator.registerArmor((ArmorItem) ModItems.STAR_GARNET_LEGGINGS);
        itemModelGenerator.registerArmor((ArmorItem) ModItems.STAR_GARNET_BOOTS);
    }
}
